  ...
  stages {
    stage('Artifactory_Configuration') {
      steps {
        script {
		  rtMaven.tool = 'Maven'
		  rtMaven.resolver releaseRepo: 'jfrog-maven-repo', snapshotRepo: 'jfrog-maven-repo-snapshot', server: server
		  buildInfo = Artifactory.newBuildInfo()
		  rtMaven.deployer releaseRepo: 'jfrog-maven-repo-local', snapshotRepo: 'jfrog-maven-repo-snapshot', server: server
